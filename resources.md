...
[**Registry of Standard Biological Parts**](https://parts.igem.org/Main_Page)<br>
Public registry of standard biological parts; mostly for iGEM

[**Addgene**](https://www.addgene.org/)<br>Nonprofit plasmid repository for public sharing

[**Addgene - Wang Lab plasmids**](https://www.addgene.org/Baojun_Wang/)<br>
Addgene collection of plasmids deposited by the Wang Lab

[**SynBERC Registry**](https://synberc-registry.jbei.org/)<br>Public registry of biological parts; mostly for SynBERC members
...
## SEQUENCE DESIGN
[**RBS Library Calculator**](https://salislab.net/software/predict_rbs_calculator) <br>Uniform sampling of protein expression for efficient combinatorial optimization. Courtesy of Salis Lab (Penn State)

[**RBS Generator**](http://github.com/hsalis/ribosome-binding-site-calculator)<br>Source code for RBS Calculator

[**ApE**](https://jorgensen.biology.utah.edu/wayned/ape/)<br>A fairly simple but very useful (free) plasmid editor software download

[**GeneDesign 3.0**](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2860129/)<br>One-stop shopping for gene construction tools (random sequence generator, reverse translation, etc)
...
[**Gene2Oligo**](https://bio.tools/gene2oligo)<br>Very useful when you need to assemble a sequence from individual oligos
...
[**Integrated Microbial Genomes**](https://img.jgi.doe.gov/) <br>Comparatively analyze genome data  by gene, genome and function
...
[**Finnzymes Tm Calculator**](https://www.thermofisher.com/us/en/home/brands/thermo-scientific/molecular-biology/molecular-biology-learning-center/molecular-biology-resource-library/thermo-scientific-web-tools/tm-calculator.html)<br>DNA melting temp calculator for Phusion PCR(nearest-neighbor method)
...
[**Rare Codon Calculator**](https://www.genscript.com/tools/rare-codon-analysis)<br>Outputs graphical information of the codon usage in your sequence
...
[**SignalP**](https://services.healthtech.dtu.dk/services/SignalP-5.0/)<br>Signal peptide cleavage site predictor

[**ProTISA**](https://pubmed.ncbi.nlm.nih.gov/17942412/)<br>Database of confirmed prokaryotic translation initiation sites

[**ExPASy**](http://ca.expasy.org/tools/) <br>Comprehensive proteomics toolbox

## ALIGNMENT TOOLS
[**LALIGN**](https://www.ebi.ac.uk/Tools/psa/lalign/)<br>Basic sequence alignment tool
...
[**FCSExtract Utility**](https://download.cnet.com/FCSExtract/3000-2054_4-75325333.html)<br>Converts \*.\*fcs files to \*.\*csv files  

## INFORMATION PORTALS
[**E. coli Statistics**](http://ccdb.wishartlab.com/)<br>Useful informatin on *E. coli*
...
[**EcoliWiki**](https://ecoliwiki.org/colipedia/index.php/Welcome_to_EcoliWiki)<br>Portal for *E. coli* research
