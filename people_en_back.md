        ...
        <table style="table-layout:fixed;">
            ...
            <tr>
                ...
                <td>
                    ...
                    Microsoft Research and Huawei Technologies, as well as DSTL and ONRG.
        ...
        <table style="table-layout:fixed;">
            ...
            <tr>
                ...
                <td width="30%" height="200" style="word-wrap:break-word;" class="des">
                    ...
                    Postdoc<br>
                    <br>
                    Synthetic biology enabling tools, pathway engineering
                    <br>
                    <br>
                </td>
                <td width="20%" class="photo">
            ...
            <tr>
                ...
                <td width="30%" height="200" style="word-wrap:break-word;" class="des">
                    <strong>Chenfan Sun</strong><br>
                    Postdoc<br>
                    <br>
                    Genetic circuit design and delivery in mammalian cells
                    <br>
                    <br>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="30%" height="200" style="word-wrap:break-word;" class="des">
                    ...
                    Postdoc<br>
                    <br>
                    Synthetic biology enabling tools & genetic circuit design
                    <br>
                    <br>
                </td>
                <td width="20%" class="photo">
            ...
            <tr>
                ...
                <td width="30%" height="200" style="word-wrap:break-word;" class="des">
                    ...
                    Postdoc<br>
                    <br>
                    Genetic circuit design and artificial cells
                    <br>
                    <br>
                </td>
                <td width="20%" class="photo">
            ...
            <tr>
                ...
                <td width="30%" height="200" style="word-wrap:break-word;" class="des">
                    ...
                    Postdoc<br>
                    <br>
                    Synthetic biological circuit design
                    <br>
                    <br>
                </td>
                <td width="20%" class="photo">
...
<div class="content panel panel-primary">
    <div class="content panel-heading">
        <h3 class="panel-title">Graduate Students</h3>
    </div>
    <div class="content panel-body">
        <table style="table-layout:fixed;">
            <tbody>
