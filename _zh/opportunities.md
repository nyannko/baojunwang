...
4. 合作研究方向（合成生物学与生物工程）： 
    ...
    4-1. 合成生物学使能技术与调控工具开发（内含肽、CRISPR基因编辑与调控等）  
    4-2. 基因元器件的挖掘、改造、模块化及正交化设计  
    4-3. 基因线路设计（包括工程化、规模化设计及生物设计自动化等）  
    4-4. 生物传感（面向环境、健康需求）与智能生物诊疗应用  
    4-5. 生物计算与生物制造应用（基于人工细胞或无细胞表达系统等）  
