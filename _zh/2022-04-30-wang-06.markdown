---
layout: post
title:  "Nat Comm | 王宝俊团队重编程tracrRNA劫持mRNAs/sRNAs/vRNA作为CRISPR RNA"
...
这项研究源自该研究团队在开发原核CRISPR激活装置的过程中（详见Bioart 2019年报道：Nat Comm | 新型原核CRISPRa实现“可投影”多基因表达谱）【1】，注意到sgRNA 骨架能够耐受RNA碱基对的改变。研究团队由此猜测crRNA与tracrRNA的配对应具有一定的可编程性。通过将原核CRISPR激活装置改造为双RNA（dual-RNA）介导的系统， crRNA-tracrRNA配对这一令人惊讶的性质被揭露出来（图1）。
